...
{
    return (PCM16_stereo_t *)malloc(sizeof(PCM16_stereo_t) * 1000000);
}
                            ...
                            PCM16_stereo_t  *buffer_p)
{
        ...
        k++)
    {
        ...
        if (fgets(str, sizeof(str), file)) {
            //buffer_p[k].left    = (int16_t)(atoi(line));
            result = strtoul(str, &ptr, 10);
            
            buffer_p[k].left    = (int32_t)(result) << 14;
            //printf("%lu\n", buffer_p[k].left);
            //printf("result is %lu\n", result);
            if (fgets(str, sizeof(str), file)) {
                result = strtoul(str, &ptr, 10);
                buffer_p[k].right    = (int32_t)(result) << 14;
                //printf("%lu\n", buffer_p[k].right);
                //printf("result is %lu\n", result);
                //printf("%d\n", k);
                //if (k == 100) break;
        ...
        //r = rand() % 20;
        //r_d = (double)r / 100.0 + 1;
        //sscanf(line, filename, "%d");
        //buffer_p[k].right   = (int16_t)(line);
    }
    printf("final k is %lld\n", k);
    return ret;
}
